<div class="header-banner">
    <img src="{{asset($department?->image)}}" alt="" class="bannerBg">
    <div class="nav">
    ...
    <div class="nav-navigate">
        <div class="nav-navigate-left">
            ...
            <h1 class="page-title">{{$department->title}}</h1>
        </div>
        <div class="breadcrumb">
            ...
            <a href="{{route('department')}}" class="breadcrumb-item">{{$department->title}}</a>
        </div>
    </div>
</div>
