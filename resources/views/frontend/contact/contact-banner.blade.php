<div class="header-banner">
    <img src="{{asset($contactBanner?->image)}}" alt="" class="bannerBg">
    <div class="nav">
    ...
    <div class="nav-navigate">
        <div class="nav-navigate-left">
            ...
            <h1 class="page-title">{{$contactBanner?->title}}</h1>
        </div>
        <div class="breadcrumb">
            ...
            <a href="{{route('contact')}}" class="breadcrumb-item">{{$contactBanner?->title_}}</a>
        </div>
    </div>
</div>
