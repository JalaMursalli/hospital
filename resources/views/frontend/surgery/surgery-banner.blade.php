<div class="header-banner">
    <img src="{{asset($surgery?->image)}}" alt="" class="bannerBg">
    <div class="nav">
    ...
    <div class="nav-navigate">
        <div class="nav-navigate-left">
            <img src="/frontend/assets/images/headTitleBg.svg" alt="">
            <h1 class="page-title">{{$surgery->title}}</h1>
        </div>
        <div class="breadcrumb">
            <a href="index.html" class="breadcrumb-item">Əsas səhifə</a>
            <span>
            ...
            <a href="{{route('surgery')}}" class="breadcrumb-item">{{$surgery->title}}</a>
        </div>
    </div>
</div>
