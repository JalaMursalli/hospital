            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.career.update',$career->id) }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">İş günləri və saatları
                                                (Az)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_az" type="text" value="{{ $career?->meta_title_az }}"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt (Az)</label>
                                                <input type="text" class="form-control" value="{{ $career?->alt_image_az }}" name="alt_image_az">
                                                 @error('alt_image_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_en" type="text" value="{{ $career?->meta_title_en }}"
                                                    id="example-text-input">
                                                @error('meta_title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $career?->alt_image_en }}" name="alt_image_en">
                                                 @error('alt_image_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_ru" type="text" value="{{ $career?->meta_title_ru }}"
                                                    id="example-text-input">
                                                @error('meta_title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $career?->alt_image_ru}}" name="alt_image_ru">
                                                @error('alt_image_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                ...
                                <div class="row mb-3 px-3">
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">İş saatları</label>
                                        <input type="text" name="workHours" class="form-control"  value="{{ $career?->workHours }}">
                                        @error('workHours')
                                            <div class="invalid-feedback" style="display: block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row mb-3 px-3">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <option value="0" {{ $career->status == 0 ? 'selected' : '' }} >Aktiv deyil </option>
                                        <option value="1" {{ $career->status == 1 ? 'selected' : '' }} >Aktiv </option>
                                        </select>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="vacancy_id" class="form-control selectric">
                                            ...
                                            @foreach ($vacancies as $vacancy)
                                                <option value="{{ $vacancy->id }}" {{ $career->vacancy_id == $vacancy->id ? 'selected' : '' }}>
                                                    {{ $vacancy->title_az }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$career?->image}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
