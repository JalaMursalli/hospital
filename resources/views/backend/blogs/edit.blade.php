            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.blog.update',$blog->id) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $blog?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt1 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image1_az }}" name="alt_image1_az">
                                                 @error('alt_image1_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt2 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image2_az }}" name="alt_image2_az">
                                                 @error('alt_image2_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image1_en }}" name="alt_image1_en">
                                                 @error('alt_image1_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image2_en }}" name="alt_image2_en">
                                                 @error('alt_image2_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image1_ru}}" name="alt_image1_ru">
                                                @error('alt_image1_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $blog?->alt_image2_ru}}" name="alt_image2_ru">
                                                @error('alt_image2_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image1-preview">
                                                ...
                                                <img style="width:200px" src="{{$blog?->image1}}" alt="">
                                            </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image2-preview">
                                                ...
                                                <input type="file" name="image2" id="image-upload-image2" />
                                                 ...
                                                 <img style="width:200px" src="{{$blog?->image2}}" alt="">
                                            </div>
                                            <div id="image2-container" style="display: none;">
                                                <img id="image2-img" src="" alt="Image2 Preview"
                                                829483912blog                         style="object-fit:cover;  border-radius: 20px; width: 200px; height: 200px;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
