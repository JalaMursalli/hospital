                        ...
                        <div class="card-header align-items-end d-flex justify-content-between">
                           <div>
                            ...
                            <div class="card-header-form">
                                <!-- Search Form -->
                                <form action="{{ route('backend.ehekim-apply.index') }}" method="GET" class="d-flex"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end " style="gap: 20px">
                                                    <a href="{{ route('backend.ehekim-apply.show', $apply?->id ?? '') }}"
                                                        class="btn btn-info btn-sm">
                                                        <i class="fas fa-eye"></i> Show
                                                    </a>

                                                    <form
                                                        action="{{ route('backend.ehekim-apply.destroy', $apply?->id ?? '') }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
