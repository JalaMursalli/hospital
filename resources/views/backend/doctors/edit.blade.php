            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.doctor.update',$doctor->id ) }}"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt (Az)</label>
                                                <input type="text" class="form-control" value="{{ $doctor?->alt_image_az }}" name="alt_image_az">
                                                 @error('alt_image_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $doctor?->alt_image_en }}" name="alt_image_en">
                                                 @error('alt_image_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $doctor?->alt_image_ru}}" name="alt_image_ru">
                                                @error('alt_image_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$doctor?->image}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
