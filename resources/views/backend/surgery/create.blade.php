...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Cərrahiyyə</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.surgery.store') }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $surgery?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_az" type="text"
                                                    value="{{ $surgery?->meta_title_az }}" id="example-text-input">
                                                @error('meta_title_az')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alt1
                                                    (Az)</label>
                                                <input type="text" class="form-control"
                                                    value="{{ old('alt_image1_az') }}" name="alt_image1_az">
                                                @error('alt_image1_az')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alt2
                                                    (Az)</label>
                                                <input type="text" class="form-control"
                                                    value="{{ old('alt_image2_az') }}" name="alt_image2_az">
                                                @error('alt_image2_az')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" type="text"
                                                    value="{{ $surgery?->title_en }}" id="example-text-input">
                                                @error('title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Alt1
                                                        (En)</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ old('alt_image1_en') }}" name="alt_image1_en">
                                                    @error('alt_image1_en')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-10">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Alt2
                                                        (En)</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ old('alt_image2_en') }}" name="alt_image2_en">
                                                    @error('alt_image2_en')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_ru" type="text"
                                                    value="{{ $surgery?->title_ru }}" id="example-text-input">
                                                @error('title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description1_ru" id="description1_ru" class="summernote">{!! $surgery->description1_ru !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description2_ru" id="description2_ru" class="summernote">{!! $surgery->description2_ru !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_ru" type="text"
                                                    value="{{ $surgery?->meta_title_ru }}" id="example-text-input">
                                                @error('meta_title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alt1
                                                    (Ru)</label>
                                                <input type="text" class="form-control"
                                                    value="{{ old('alt_image1_ru') }}" name="alt_image1_ru">
                                                @error('alt_image1_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alt2
                                                    (Ru)</label>
                                                <input type="text" class="form-control"
                                                    value="{{ old('alt_image2_ru') }}" name="alt_image2_ru">
                                                @error('alt_image2_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
    ...
    @push('js')
        ...
        <script>
            ...
            handleImagePreview('image-upload-icon', 'icon-img', 'icon-container');
