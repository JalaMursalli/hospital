            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.checkup.update',$checkup->id) }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $checkup?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_az" class="summernote">{!! $checkup->description_az !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_az" type="text" value="{{ $checkup?->meta_title_az }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_az" class="summernote">{!!$checkup->meta_description_az !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt1 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image1_az }}" name="alt_image1_az">
                                                 @error('alt_image1_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt2 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image2_az }}" name="alt_image2_az">
                                                 @error('alt_image2_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" type="text"
                                                    value="{{ $checkup?->title_en }}" id="example-text-input">
                                                @error('title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_en" class="summernote">{!! $checkup->description_en !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_en" type="text" value="{{ $checkup?->meta_title_en }}"
                                                    id="example-text-input">
                                                @error('meta_title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_en" class="summernote">{!!$checkup->meta_description_en !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image1_en }}" name="alt_image1_en">
                                                 @error('alt_image1_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image2_en }}" name="alt_image2_en">
                                                 @error('alt_image2_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_ru" type="text"
                                                    value="{{ $checkup?->title_ru }}" id="example-text-input">
                                                @error('title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="description_ru" class="summernote">{!! $checkup->description_ru !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="meta_title_ru" type="text" value="{{ $checkup?->meta_title_ru }}"
                                                    id="example-text-input">
                                                @error('meta_title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_ru" class="summernote">{!!$checkup->meta_description_ru !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image1_ru}}" name="alt_image1_ru">
                                                @error('alt_image1_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $checkup?->alt_image2_ru}}" name="alt_image2_ru">
                                                @error('alt_image2_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                ...
                                <div class="row mb-3 px-3">
                                    <label for="example-price-input" class="col-sm-2 col-form-label">Qiymət</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="price" type="number" step="0.01" value="{{ $checkup?->price }}" id="example-price-input">
                                        @error('price')
                                            <div class="invalid-feedback" style="display: block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row mb-3 px-3">
                                    <label for="example-price-input" class="col-sm-2 col-form-label">Endirimli Qiymət</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="discounted_price" type="number" step="0.01" value="{{ $checkup?->discounted_price }}" id="example-price-input">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image1-preview">
                                                ...
                                                <img style="width:200px" src="{{$checkup?->image1}}" alt="">
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image2-preview">
                                                ...
                                                <img style="width:200px" src="{{$checkup?->image2}}" alt="">
                                            </div>
