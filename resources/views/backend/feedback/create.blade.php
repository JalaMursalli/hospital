            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Feedback</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.feedback.store') }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Vəzifə (Az)
                                            </label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="position_az"
                                                    value="{{ $feedback?->position_az }}" id="example-text-input">
                                                @error('position_az')
                                    ...
                                    <div class="tab-pane" id="en">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Vəzifə (En)
                                            </label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="position_en"
                                                    value="{{ $feedback?->position_en }}" id="example-text-input">
                                                @error('position_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Vəzifə (Ru)
                                            </label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="position_ru"
                                                    value="{{ $feedback?->position_ru }}" id="example-text-input">
                                                @error('position_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
