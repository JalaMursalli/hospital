            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.seminar.update',$seminar->id) }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $seminar?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="sub_title_az" type="text"
                                                    value="{{ $seminar?->sub_title_az }}" id="example-text-input">
                                                @error('sub_title_az')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_az" class="summernote">{!! $seminar->description_az !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt1 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image1_az }}" name="alt_image1_az">
                                                 @error('alt_image1_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                              <label for="example-text-input" class="col-sm-2 col-form-label">Alt2 (Az)</label>
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image2_az }}" name="alt_image2_az">
                                                 @error('alt_image2_az')
                                                     <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" type="text"
                                                    value="{{ $seminar?->title_en }}" id="example-text-input">
                                                @error('title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="sub_title_en" type="text"
                                                    value="{{ $seminar?->sub_title_en }}" id="example-text-input">
                                                @error('sub_title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_en" class="summernote">{!! $seminar->description_en !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image1_en }}" name="alt_image1_en">
                                                 @error('alt_image1_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image2_en }}" name="alt_image2_en">
                                                 @error('alt_image2_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_ru" type="text"
                                                    value="{{ $seminar?->title_ru }}" id="example-text-input">
                                                @error('title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="sub_title_ru" type="text"
                                                    value="{{ $seminar?->sub_title_ru }}" id="example-text-input">
                                                @error('sub_title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="description_ru" class="summernote">{!! $seminar->description_ru !!}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image1_ru}}" name="alt_image1_ru">
                                                @error('alt_image1_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" value="{{ $seminar?->alt_image2_ru}}" name="alt_image2_ru">
                                                @error('alt_image2_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                         {{ $message }}
                                                    </div>
                                ...
                                <div class="row mb-3 px-3">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tip</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select name="type" class="form-control selectric">
                                            <option value="">Tipi seç</option>
                                        <option value="0"  {{!$seminar->type ? 'selected': ''}}>Seminarlar </option>
                                        <option value="1"  {{$seminar->type ? 'selected': ''}}>Məlumatlar </option>
                                        </select>

                                    </div>
                                </div>
                                <div class="row mb-3 px-3">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Status Ödəniş</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select name="priceStatus" class="form-control selectric">
                                            <option value="">Statusu seç</option>
                                        <option value="0"  {{!$seminar->priceStatus ? 'selected': ''}}>Ödənişsiz </option>
                                        <option value="1"  {{$seminar->priceStatus ? 'selected': ''}}>Ödənişli </option>
                                        </select>
                                ...
                                <div class="row mb-3 px-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="date" type="date" value="{{ $seminar?->date }}" id="example-date-input">
                                        @error('date')
                                            <div class="invalid-feedback" style="display: block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row mb-3 px-3">
                                    <label for="example-number-input" class="col-sm-2 col-form-label">Baxış Sayı</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="countView" type="number" value="{{ $seminar?->countView }}" id="example-number-input">
                                        @error('countView')
                                            <div class="invalid-feedback" style="display: block">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image1-preview">
                                                ...
                                                <img style="width:200px" src="{{$seminar?->image1}}" alt="">
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="image-preview" id="image2-preview">
                                                ...
                                                <img style="width:200px" src="{{$seminar?->image2}}" alt="">
                                            </div>
