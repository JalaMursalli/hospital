            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Seminar</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.seminar.store') }}"
                                ...
                                <div class="row mb-3 px-3">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <option value="0" >Seminarlar </option>
                                        <option value="1" >Məlumatlar </option>
                                        </select>
