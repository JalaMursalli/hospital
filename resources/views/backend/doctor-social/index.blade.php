                        ...
                        <div class="card-header align-items-end d-flex justify-content-between">
                           <div>
                            ...
                            <div class="card-header-form">
                                <!-- Search Form -->
                                <form action="{{ route('backend.doctor-social.index') }}" method="GET" class="d-flex"
                            ...
                            <a href="{{ route('backend.doctor-social.create',['doctor_id'=>request('doctor_id')]) }}" class="btn btn-primary">Yeni Sosial Şəbəkə yarat</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end " style="gap: 20px">
                                                    <a href="{{ route('backend.doctor-social.edit', $social?->id ?? '') }}"
                                                        class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <form
                                                        action="{{ route('backend.doctor-social.destroy', $social?->id ?? '') }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
