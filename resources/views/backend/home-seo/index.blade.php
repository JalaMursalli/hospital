                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_az" class="summernote">{!!$home?->meta_description_az !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="en">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_en" class="summernote">{!!$home?->meta_description_en !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="meta_description_ru" class="summernote">{!!$home?->meta_description_ru !!}</textarea>
