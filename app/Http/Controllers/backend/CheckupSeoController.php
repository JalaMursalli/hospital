...
use App\Models\CheckupSeo;
use Illuminate\Http\Request;

class CheckupSeoController extends Controller
{
    /**
    ...
    {
        $checkup = CheckupSeo::first();
        return view('backend.checkup-seo.index',compact('checkup'));
    }
