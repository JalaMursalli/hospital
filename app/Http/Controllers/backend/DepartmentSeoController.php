...
use App\Models\DepartmentSeo;
use Illuminate\Http\Request;

class DepartmentSeoController extends Controller
{
    /**
    ...
    {
        $department = DepartmentSeo::first();
        return view('backend.department-seo.index',compact('department'));
    }
