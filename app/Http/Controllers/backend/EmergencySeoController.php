...
use App\Models\EmergencySeo;
use Illuminate\Http\Request;

class EmergencySeoController extends Controller
{
    /**
    ...
    {
        $emergency = EmergencySeo::first();
        return view('backend.emergency-seo.index',compact('emergency'));
    }
